...
class Plan(BaseModel):
    ...
    description: str = Field(
        description="A online description of the app to be built, e.g. 'A web application for managing perso' ")
    techstack: str = Field(
        description="The techstack to be used for the app, e.g. 'python', 'javascript', 'react' , 'flask', etc")
...
class ImplementationTask(BaseModel):
    ...
    task_description: str = Field(description="A detailed description of the task to be performed on the file, e.g, 'add user' ")
...
class CoderState(BaseModel):
    ...
    current_file_content: str = Field(default="", description="The content of the file currently being edited or created")
